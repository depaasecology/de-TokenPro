...
import { useWindowDimensions, View,
  Linking,
...
export const Debug = () => {
  ...
  const btnFn = useCallback(async () => {
    const supportedURL = 'https://google.com';
    const unsupportedURL = 'sms:+123456789';

    console.log(await Linking.canOpenURL('so.onekey.app.wallet://'))
    console.log(await Linking.canOpenURL('onekey-wallet://'))
    console.log(await Linking.canOpenURL('ethereum://'))
    console.log(await Linking.canOpenURL('itms-apps://'))
    console.log(await Linking.canOpenURL('market://'))
    console.log(await Linking.canOpenURL('hiapplink://'))
    console.log(await Linking.canOpenURL('com.baidu.netdisk://'))
    console.log(await Linking.canOpenURL('com.vivo.email//'))
    console.log(await Linking.canOpenURL('wc://'))
    console.log(await Linking.canOpenURL('qq://'))
    console.log(await Linking.canOpenURL('com.ssandroid.ugc.aweme://'))
    console.log(await Linking.canOpenURL('com.pingan.paces.ccms://'))
    console.log(await Linking.canOpenURL('com.xuemeng.pinduoduo://'))
    console.log(await Linking.canOpenURL('ms-windows-store://'))
    console.log(await Linking.canOpenURL('com.tencent.mobileqq://'))
    console.log(await Linking.canOpenURL('com.msgsoftware.globalchats://'))
    console.log(await Linking.canOpenURL('com.bbk.appstre://'))
    console.log(await Linking.canOpenURL('im.token.app://'))
    console.log(await Linking.canOpenURL('net.cozic.joplin://'))
    console.log(await Linking.canOpenURL('net.artsy.app://'))
    console.log(await Linking.canOpenURL('https://metamask.app.link/dapp/www.jobinleung.me/sign'))
    console.log(await Linking.canOpenURL('imtokenv2://navigate/AssetsTab'))

    await Linking.openURL('imtokenv2://');
    ...
    // } else{
    //   console.log('false openURL')
    // }
    // else {
    //   openUrl(unsupportedURL);
    // }
  }, []);
  ...
  return (
    <Box>
      {/* <CustomSkeleton w="100%" h="100px" /> */}
      <Button onPress={btnFn}>btn</Button>
    </Box>
  );
