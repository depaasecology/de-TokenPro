...
const MarketList: FC = () => {
  ...
  const coingeckoIds = useMemo(() => {
    return selectedCategory && selectedCategory.coingeckoIds ? [...selectedCategory.coingeckoIds] : []
    let arr = selectedCategory && selectedCategory.coingeckoIds ? [...selectedCategory.coingeckoIds] : []
    return [arr?.shift(), 'test12', ...arr]
  }, [selectedCategory?.coingeckoIds]);


  // console.log(selectedCategory)
  // console.log(coingeckoIds)
  // console.log(selectedCategory?.coingeckoIds)
