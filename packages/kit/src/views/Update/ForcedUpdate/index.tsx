...
const ForcedUpdate: FC = () => {
  ...
  const { versionInfo, updateDate } = useRoute<RouteProps>().params;
  ...
  return (
    <Modal
      ...
      onPrimaryActionPress={() => appUpdates.openUrl({
        download: updateDate.releaseOpenUrl
      })}
      scrollViewProps={{
        disableScrollViewPanResponder: true,
        children: updateDate.updateContent ? (
          <>
            <SkipAppLock />
            ...
            <Markdown>{updateDate.updateContent}</Markdown>
          </>
        ) : (
          <Center>
            <Spinner size="lg" />
