...
export function useAccountTokens(
  ...
  // 需要修改风险等级代币的address
  // const editRiskLevelAddressList:string[] = [
  //   '0xbae3cb76e6c63878425ff165e8fce87088190da8',
  //   '0xa6b882ae46aa5c84f71e670592197b12e0839773',
  //   '0x2b8237c658ba4c482fd29235d6713554d117a937'
  // ]
  // const editRiskLevelNetworkId:string = 'evm--56'
  ...
  const filteredTokens = valueTokens.filter((t) => {
    ...
    // 修改风险等级（riskLevel）
    // if(t?.networkId === editRiskLevelNetworkId && editRiskLevelAddressList.includes(t?.address || '')) {
    //   t.riskLevel = 0
    // }
  ...
  // console.log([nativeToken,filteredTokens])
